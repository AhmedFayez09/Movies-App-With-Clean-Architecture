...
import 'package:movies_app_with_clean_ar/movies/presentation/screens/movie_detail_screen.dart';
        ...
        builder: (context, state) {
          ...
          switch (state.nowPlayingState) {
                    ...
                    (item) {
                      return GestureDetector(
                        ...
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (c)=> MovieDetailScreen(id: item.id)));
                        },
                        child: Stack(
                          children: [
                            ShaderMask(
            ...
            case RequestState.error:
              return SizedBox(
                height: 400.0,
                child: Text(state.newPlayingMessage,style: const TextStyle(color: Colors.black,fontSize: 30),),
              );
          }
        });
  }
